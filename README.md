...
> **一句话**：让外面的技术变化，沉淀成团队的资产。

**① 采（技术动态采集）**
- 输入：订阅源（Trending / HN / 博客 / 内部 RSS）+ 你的标签
- 输出：日报 / 简报
- 落地：企微 / 腾讯文档 / 乐享

**② 沉（知识沉淀）**
- 输入：仓库地址（GitHub / GitLab / Gitee / 本地）
- 输出：架构图 + 决策文档 + 新人 30 分钟上手指南
- 落地：团队知识库
- 增量：下次再扫，能对比差异
...
**③ 选（多方案选型对比）**
- 触发：看完动态想动点什么——升级、替换、新选型
- 输入：2~5 个备选方案（技术 / 供应商 / 产品 / 架构都行）
- 输出：选型报告：推谁 + 风险 + POC 清单
- 落地：可作 ADR 存档
